...
def main():
    try:
        ...
        # Cursor provides: conversation_id, generation_id, hook_event_name, workspace_roots, command, working_directory
        ...
        if is_env_file_access(command):
            ...
            sys.exit(3)  # Exit code 3 blocks tool call in Cursor
